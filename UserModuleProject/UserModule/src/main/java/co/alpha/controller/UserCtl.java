...
public class UserCtl extends BaseCtl<UserForm, UserDTO, UserServiceInt> {
	...
	public List<ORSResponse> createMultiple(@RequestBody List<UserForm> usersForms) {

		List<Long> idsList = new ArrayList<>();
		List<ORSResponse> resList = new ArrayList<ORSResponse>();
		...
		for (UserForm userForm : usersForms) {
			...
			if (rollDto != null) {
				...
				if (createDto.getId() != null && !rollDto.getRollNo().equals(createDto.getRollNo())) {
